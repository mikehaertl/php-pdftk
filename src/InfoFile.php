...
class InfoFile extends File
{
     ...
     * Constructor
     *
     * @param array $data The PDF meta-data. If $data contains an array key
     *                    'Info' then the data is interpreted in the form
     *                    generated by Pdf::getData(). If the 'Info'-key is
     *                    missing, the $data is interpreted as just the
     *                    'Info'-part of the output of Pdf::getData(), that
     *                    is: just the info-value as name => value pairs.
